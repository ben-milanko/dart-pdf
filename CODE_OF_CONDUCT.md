...
To report a possible violation, email **ben.milanko@protonmail.com**. Reports
will be reviewed promptly and handled as confidentially as possible.
...
2. **Temporarily Limited Activities**
   ...
   - **Repair:** Examples may include making an apology, using the cooldown
...
4.0](https://creativecommons.org/licenses/by-sa/4.0/). Additional enforcement
and community guideline resources are available from the [Contributor Covenant
project](https://www.contributor-covenant.org/resources/).
