...
| `letterhead-report-40p.pdf` | corporate report | the office text above under one small shared letterhead image XObject per page - the ordinary "every page declares an /XObject" shape that a has-an-image? render policy misreads as expensive |
