...
#include <dart_pdf_printing/dart_pdf_printing_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) dart_pdf_printing_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "DartPdfPrintingPlugin");
  dart_pdf_printing_plugin_register_with_registrar(dart_pdf_printing_registrar);
