...
**Tiers 1 and 2 both ship** — 19 UI locales in all. Spanish landed first
...
id, pl, nl, th, uk. `supportedLocales` is now `[ar, de, en, es, fr, hi, id,
it, ja, ko, nl, pl, pt, ru, th, tr, uk, vi, zh, zh_Hant]`, and Arabic makes it
