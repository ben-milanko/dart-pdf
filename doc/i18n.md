...
such as the HTTP `Authorization` header. The Settings licence link uses Flutter's
regional Material label, matching the licence page it opens. Context-dependent
words such as license/licence and meter/metre require review when introduced; this is a
