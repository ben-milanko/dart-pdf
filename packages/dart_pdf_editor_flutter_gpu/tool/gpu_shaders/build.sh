...
bundle=$(cat <<EOF
{
  ...
  "PdfTileBlendFragment":  {"type":"fragment", "file":"$src/pdf_tile_blend.frag"},
  "PdfTileGlyphVertex":    {"type":"vertex",   "file":"$src/pdf_tile_glyph.vert"},
  "PdfTileGlyphFragment":  {"type":"fragment", "file":"$src/pdf_tile_glyph.frag"},
