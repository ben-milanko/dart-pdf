...
class DartPdfEditorLocalizationsJa extends DartPdfEditorLocalizations {
  ...
  String get formXfaUnsupportedNotice =>
      'このフォームは XFA を使用しているため、ここでは入力できず、フィールドも表示されません。入力するには XFA フォームに対応したアプリで開いてください。';
  ...
  @override
  String get sigUseTrackpad => 'トラックパッドを使用';

  @override
  String get sigTrackpadHint => '1本指でトラックパッドに描いてください。終わったら任意のキーを押します。';
