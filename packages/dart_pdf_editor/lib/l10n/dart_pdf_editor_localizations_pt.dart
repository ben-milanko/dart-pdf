...
class DartPdfEditorLocalizationsPt extends DartPdfEditorLocalizations {
  ...
  String get formXfaUnsupportedNotice =>
      'Este formulário usa XFA, que não pode ser preenchido aqui, por isso os campos não aparecem. Abra-o em um aplicativo compatível com formulários XFA para preenchê-lo.';
  ...
  String get sigTrackpadHint =>
      'Desenhe no trackpad com um dedo. Pressione qualquer tecla quando terminar.';
  ...
  @override
  String get tbToolContentDelete => 'Apagar';
