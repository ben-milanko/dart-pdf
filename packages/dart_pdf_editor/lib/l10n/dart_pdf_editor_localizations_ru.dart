...
class DartPdfEditorLocalizationsRu extends DartPdfEditorLocalizations {
  ...
  String get formXfaUnsupportedNotice =>
      'Эта форма использует XFA, которую здесь нельзя заполнить, поэтому её поля не отображаются. Чтобы заполнить её, откройте в приложении с поддержкой форм XFA.';
  ...
  @override
  String get sigUseTrackpad => 'Использовать трекпад';

  @override
  String get sigTrackpadHint =>
      'Рисуйте одним пальцем на трекпаде. Когда закончите, нажмите любую клавишу.';
