...
class PdfPageRenderer {
  ...
  /// shift, y-flip, /Rotate, ratio). Public so alternative strip replay
  /// paths (the retained scene in `strips/strip_scene.dart`) hand
  /// [StripPdfDevice] the exact transform this renderer paints under.
