...
- Add a persistent reusable-annotation library backed by detached
  `PdfAnnotationSnapshot`s, with context-menu capture, cross-document
  placement, repeat Paste, and a direct path to the custom-stamp collection.
