...
/// AFM advance widths for Helvetica, characters 32–255, in thousandths of
/// an em (Adobe base-14 metrics) under WinAnsiEncoding - the encoding
/// every base-14 /Font dict written here declares. Codes WinAnsi leaves
/// undefined carry the bullet width, which is what they render as
...
const List<int> helveticaWidths = [
  ...
  278, 556, 500, 722, 500, 500, 500, 334, 260, 334, 584, 350, 556, 350, //
  222, 556, 333, 1000, 556, 556, 333, 1000, 667, 333, 1000, 350, 611, 350, //
  350, 222, 222, 333, 333, 350, 556, 1000, 333, 1000, 500, 333, 944, 350, //
  500, 667, 278, 333, 556, 556, 556, 556, 260, 556, 333, 737, 370, 556, //
  584, 333, 737, 333, 400, 584, 333, 333, 333, 556, 537, 278, 333, 333, //
  365, 556, 834, 834, 834, 611, 667, 667, 667, 667, 667, 667, 1000, 722, //
  667, 667, 667, 667, 278, 278, 278, 278, 722, 722, 778, 778, 778, 778, //
  778, 584, 778, 722, 722, 722, 722, 667, 667, 611, 556, 556, 556, 556, //
  556, 556, 889, 500, 556, 556, 556, 556, 278, 278, 278, 278, 556, 556, //
  556, 556, 556, 556, 556, 584, 611, 556, 556, 556, 556, 500, 556, 500, //
];

/// AFM advance widths for Helvetica-Bold, characters 32–255.
const List<int> helveticaBoldWidths = [
  ...
  333, 611, 556, 778, 556, 556, 500, 389, 280, 389, 584, 350, 556, 350, //
  278, 556, 500, 1000, 556, 556, 333, 1000, 667, 333, 1000, 350, 611, 350, //
  350, 278, 278, 500, 500, 350, 556, 1000, 333, 1000, 556, 333, 944, 350, //
  500, 667, 278, 333, 556, 556, 556, 556, 280, 556, 333, 737, 370, 556, //
  584, 333, 737, 333, 400, 584, 333, 333, 333, 611, 556, 278, 333, 333, //
  365, 556, 834, 834, 834, 611, 722, 722, 722, 722, 722, 722, 1000, 722, //
  667, 667, 667, 667, 278, 278, 278, 278, 722, 722, 778, 778, 778, 778, //
  778, 584, 778, 722, 722, 722, 722, 667, 667, 611, 556, 556, 556, 556, //
  556, 556, 889, 556, 556, 556, 556, 556, 278, 278, 278, 278, 611, 611, //
  611, 611, 611, 611, 611, 584, 611, 611, 611, 611, 611, 556, 611, 556, //
];

/// AFM advance widths for Times-Roman, characters 32–255.
const List<int> timesRomanWidths = [
  ...
  278, 500, 500, 722, 500, 500, 444, 480, 200, 480, 541, 350, 500, 350, //
  333, 500, 444, 1000, 500, 500, 333, 1000, 556, 333, 889, 350, 611, 350, //
  350, 333, 333, 444, 444, 350, 500, 1000, 333, 980, 389, 333, 722, 350, //
  444, 722, 250, 333, 500, 500, 500, 500, 200, 500, 333, 760, 276, 500, //
  564, 333, 760, 333, 400, 564, 300, 300, 333, 500, 453, 250, 333, 300, //
  310, 500, 750, 750, 750, 444, 722, 722, 722, 722, 722, 722, 889, 667, //
  611, 611, 611, 611, 333, 333, 333, 333, 722, 722, 722, 722, 722, 722, //
  722, 564, 722, 722, 722, 722, 722, 722, 556, 500, 444, 444, 444, 444, //
  444, 444, 667, 444, 444, 444, 444, 444, 278, 278, 278, 278, 500, 500, //
  500, 500, 500, 500, 500, 564, 500, 500, 500, 500, 500, 500, 500, 500, //
];

/// AFM advance widths for Times-Bold, characters 32–255.
const List<int> timesBoldWidths = [
  ...
  333, 556, 500, 722, 500, 500, 444, 394, 220, 394, 520, 350, 500, 350, //
  333, 500, 500, 1000, 500, 500, 333, 1000, 556, 333, 1000, 350, 667, 350, //
  350, 333, 333, 500, 500, 350, 500, 1000, 333, 1000, 389, 333, 722, 350, //
  444, 722, 250, 333, 500, 500, 500, 500, 220, 500, 333, 747, 300, 500, //
  570, 333, 747, 333, 400, 570, 300, 300, 333, 556, 540, 250, 333, 300, //
  330, 500, 750, 750, 750, 500, 722, 722, 722, 722, 722, 722, 1000, 722, //
  667, 667, 667, 667, 389, 389, 389, 389, 722, 722, 778, 778, 778, 778, //
  778, 570, 778, 722, 722, 722, 722, 722, 611, 556, 500, 500, 500, 500, //
  500, 500, 722, 444, 444, 444, 444, 444, 278, 278, 278, 278, 500, 556, //
  500, 500, 500, 500, 500, 570, 500, 556, 556, 556, 556, 500, 556, 500, //
];

/// AFM advance widths for Times-Italic, characters 32–255.
const List<int> timesItalicWidths = [
  ...
  278, 500, 444, 667, 444, 444, 389, 400, 275, 400, 541, 350, 500, 350, //
  333, 500, 556, 889, 500, 500, 333, 1000, 500, 333, 944, 350, 556, 350, //
  350, 333, 333, 556, 556, 350, 500, 889, 333, 980, 389, 333, 667, 350, //
  389, 556, 250, 389, 500, 500, 500, 500, 275, 500, 333, 760, 276, 500, //
  675, 333, 760, 333, 400, 675, 300, 300, 333, 500, 523, 250, 333, 300, //
  310, 500, 750, 750, 750, 500, 611, 611, 611, 611, 611, 611, 889, 667, //
  611, 611, 611, 611, 333, 333, 333, 333, 722, 667, 722, 722, 722, 722, //
  722, 675, 722, 722, 722, 722, 722, 556, 611, 500, 500, 500, 500, 500, //
  500, 500, 667, 444, 444, 444, 444, 444, 278, 278, 278, 278, 500, 500, //
  500, 500, 500, 500, 500, 675, 500, 500, 500, 500, 500, 444, 500, 444, //
];

/// AFM advance widths for Times-BoldItalic, characters 32–255.
const List<int> timesBoldItalicWidths = [
  ...
  278, 556, 444, 667, 500, 444, 389, 348, 220, 348, 570, 350, 500, 350, //
  333, 500, 500, 1000, 500, 500, 333, 1000, 556, 333, 944, 350, 611, 350, //
  350, 333, 333, 500, 500, 350, 500, 1000, 333, 1000, 389, 333, 722, 350, //
  389, 611, 250, 389, 500, 500, 500, 500, 220, 500, 333, 747, 266, 500, //
  606, 333, 747, 333, 400, 570, 300, 300, 333, 576, 500, 250, 333, 300, //
  300, 500, 750, 750, 750, 500, 667, 667, 667, 667, 667, 667, 944, 667, //
  667, 667, 667, 667, 389, 389, 389, 389, 722, 722, 722, 722, 722, 722, //
  722, 570, 722, 722, 722, 722, 722, 611, 611, 500, 500, 500, 500, 500, //
  500, 500, 722, 444, 444, 444, 444, 444, 278, 278, 278, 278, 500, 556, //
  500, 500, 500, 500, 500, 570, 500, 556, 556, 556, 556, 444, 500, 444, //
];

/// Measures [text] in points at [fontSize], using base-14 Helvetica
/// metrics. Characters outside 32–255 count as an average width.
double measureHelvetica(String text, double fontSize, {bool bold = false}) {
  final table = bold ? helveticaBoldWidths : helveticaWidths;
  var total = 0;
  for (final code in text.codeUnits) {
    total += code >= 32 && code <= 255 ? table[code - 32] : 556;
  }
...
enum PdfStandardFont implements PdfTextFont {
  ...
  ///
  /// Covers the whole WinAnsi range, not just ASCII: [ContentWriter.showText]
  /// emits Latin-1 bytes verbatim, so an accented name measured here must
  /// agree with the /Widths this font writes - a viewer takes the advance
  /// from that array, and a code missing from it advances by /MissingWidth
  /// (0 by default), piling the glyphs on top of each other.
  int widthOf(int code) {
    final widths = _widths;
    if (widths == null) return _fallbackWidth;
    return code >= 32 && code <= 255 ? widths[code - 32] : _fallbackWidth;
  }

  /// Advance widths for characters 32–255 (the font dict's /Widths, written
  /// with /FirstChar 32 and /LastChar 255).
  List<int> get widths => _widths ?? List.filled(224, _fallbackWidth);
